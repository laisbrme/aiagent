...
yahoo_finance_tool = Tool(
    ...
    description = "Fetch stock prices for {ticket} from the last year about a specific stock from Yahoo Finance API",
...
newsAnalyst = Agent(
    ...
    You're understand news, theirs tittles and information, but you look at those with a health dose of skepticism.
...
stockAnalystWrite = Agent(
    ...
    You understand macho factors and combine multiple theories - eg. cycle theory and fundamental analyses.
...
# TAREFA PARA O TERCEIRO AGENTE
writeAnalyses = Task(
    description = """Use the stock price trend and the stock news report to create an analyses and write the newsletter about the {ticket} company that is brief and highlight the most important points.
    Focus on the stock price trend, news and frear/greed score. What are the near future considerations?
...
# CRIANDO O GRUPO DE AGENTES DE IA
crew = Crew(
